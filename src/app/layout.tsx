...
export const metadata: Metadata = {
  title: { default: `${siteConfig.appName} · 求职指挥台`, template: `%s · ${siteConfig.appName}` },
  description: `${siteConfig.ownerName} 的求职 end-to-end 指挥台：今日、公司、备战、Offers、时间线`,
    ...
    <html lang="zh-CN" suppressHydrationWarning data-repo-wallpaper={wp || undefined}>
      <body>
        ...
        <footer className="footer">
          ...
          <a href={`https://github.com/${siteConfig.githubRepo}`} target="_blank" rel="noreferrer">
            GitHub
          </a>
        </footer>
      </body>
